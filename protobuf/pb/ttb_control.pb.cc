...
const uint32_t TableStruct_ttb_5fcontrol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::TtbSetVel, acc_x_),
  PROTOBUF_FIELD_OFFSET(::TtbSetVel, acc_y_),
  PROTOBUF_FIELD_OFFSET(::TtbSetVel, dec_x_),
  PROTOBUF_FIELD_OFFSET(::TtbSetVel, dec_y_),
  ...
  PROTOBUF_FIELD_OFFSET(::TtbSetPos, pos_max_acc_),
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 24, -1, -1, sizeof(::TtbSetPos)},
  { 33, -1, -1, sizeof(::TtbRe)},
  { 46, -1, -1, sizeof(::TtbState)},
};
...
const char descriptor_table_protodef_ttb_5fcontrol_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "pos_y\030\006 \001(\0132\n.TtbSetPos\022\n\n\002hb\030\007 \001(\004\"e\n\tT"
  "tbSetVel\022\r\n\005acc_x\030\001 \001(\002\022\r\n\005acc_y\030\002 \001(\002\022\r"
  "\n\005dec_x\030\003 \001(\002\022\r\n\005dec_y\030\004 \001(\002\022\r\n\005vel_x\030\005 "
  "\001(\002\022\r\n\005vel_y\030\006 \001(\002\"B\n\tTtbSetPos\022\013\n\003pos\030\001"
  " \001(\001\022\023\n\013pos_max_acc\030\002 \001(\002\022\023\n\013pos_max_vel"
  "\030\003 \001(\002\"\264\001\n\005TtbRe\022\021\n\trun_count\030\001 \001(\004\022\036\n\014n"
  "ow_ttb_mode\030\002 \001(\0162\010.TtbMode\022\030\n\005state\030\003 \001"
...
const ::_pbi::DescriptorTable descriptor_table_ttb_5fcontrol_2eproto = {
    false, false, 895, descriptor_table_protodef_ttb_5fcontrol_2eproto,
    "ttb_control.proto",
...
TtbSetVel::TtbSetVel(const TtbSetVel& from)
  ...
  ::memcpy(&acc_x_, &from.acc_x_,
    ...
    reinterpret_cast<char*>(&acc_x_)) + sizeof(vel_y_));
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 29)) {
          dec_x_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 37)) {
          dec_y_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* TtbSetVel::_InternalSerialize(
  ...
  // float dec_x = 3;
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_dec_x = this->_internal_dec_x();
  uint32_t raw_dec_x;
  memcpy(&raw_dec_x, &tmp_dec_x, sizeof(tmp_dec_x));
  if (raw_dec_x != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(3, this->_internal_dec_x(), target);
  }

  // float dec_y = 4;
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_dec_y = this->_internal_dec_y();
  uint32_t raw_dec_y;
  memcpy(&raw_dec_y, &tmp_dec_y, sizeof(tmp_dec_y));
  if (raw_dec_y != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(4, this->_internal_dec_y(), target);
  }
  ...
  if (raw_vel_x != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(5, this->_internal_vel_x(), target);
  }
  ...
  if (raw_vel_y != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(6, this->_internal_vel_y(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:TtbSetVel)
  ...
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_dec_x = from._internal_dec_x();
  uint32_t raw_dec_x;
  memcpy(&raw_dec_x, &tmp_dec_x, sizeof(tmp_dec_x));
  if (raw_dec_x != 0) {
    _internal_set_dec_x(from._internal_dec_x());
  }
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_dec_y = from._internal_dec_y();
  uint32_t raw_dec_y;
  memcpy(&raw_dec_y, &tmp_dec_y, sizeof(tmp_dec_y));
  if (raw_dec_y != 0) {
    _internal_set_dec_y(from._internal_dec_y());
  }
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 21)) {
          pos_max_acc_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* TtbSetPos::_InternalSerialize(
  ...
  // float pos_max_acc = 2;
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_pos_max_acc = this->_internal_pos_max_acc();
  uint32_t raw_pos_max_acc;
  memcpy(&raw_pos_max_acc, &tmp_pos_max_acc, sizeof(tmp_pos_max_acc));
  if (raw_pos_max_acc != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(2, this->_internal_pos_max_acc(), target);
  }
  ...
  if (raw_pos_max_vel != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(3, this->_internal_pos_max_vel(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:TtbSetPos)
  ...
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_pos_max_acc = from._internal_pos_max_acc();
  uint32_t raw_pos_max_acc;
  memcpy(&raw_pos_max_acc, &tmp_pos_max_acc, sizeof(tmp_pos_max_acc));
  if (raw_pos_max_acc != 0) {
    _internal_set_pos_max_acc(from._internal_pos_max_acc());
  }
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
