...
class TtbSetVel final :
 ...
 public:
  ...
  void clear_dec_x();
  float dec_x() const;
  void set_dec_x(float value);
  private:
  float _internal_dec_x() const;
  void _internal_set_dec_x(float value);
  public:

  // float dec_y = 4;
  void clear_dec_y();
  float dec_y() const;
  void set_dec_y(float value);
  private:
  float _internal_dec_y() const;
  void _internal_set_dec_y(float value);
  public:
...
class TtbSetPos final :
 ...
 public:
  ...
  enum : int {
    kPosFieldNumber = 1,
    kPosMaxAccFieldNumber = 2,
    kPosMaxVelFieldNumber = 3,
  };
  // double pos = 1;
  void clear_pos();
  double pos() const;
  ...
  // float pos_max_acc = 2;
  void clear_pos_max_acc();
  float pos_max_acc() const;
  void set_pos_max_acc(float value);
  private:
  float _internal_pos_max_acc() const;
  void _internal_set_pos_max_acc(float value);
  public:
...
// float acc_x = 1;
inline void TtbSetVel::clear_acc_x() {
  acc_x_ = 0;
}
inline float TtbSetVel::_internal_acc_x() const {
  return acc_x_;
}
inline float TtbSetVel::acc_x() const {
  // @@protoc_insertion_point(field_get:TtbSetVel.acc_x)
  return _internal_acc_x();
}
inline void TtbSetVel::_internal_set_acc_x(float value) {
  
  acc_x_ = value;
}
inline void TtbSetVel::set_acc_x(float value) {
  _internal_set_acc_x(value);
  // @@protoc_insertion_point(field_set:TtbSetVel.acc_x)
}

// float acc_y = 2;
inline void TtbSetVel::clear_acc_y() {
  acc_y_ = 0;
}
inline float TtbSetVel::_internal_acc_y() const {
  return acc_y_;
}
inline float TtbSetVel::acc_y() const {
  // @@protoc_insertion_point(field_get:TtbSetVel.acc_y)
  return _internal_acc_y();
}
inline void TtbSetVel::_internal_set_acc_y(float value) {
  
  acc_y_ = value;
}
inline void TtbSetVel::set_acc_y(float value) {
  _internal_set_acc_y(value);
  // @@protoc_insertion_point(field_set:TtbSetVel.acc_y)
}

// float dec_x = 3;
inline void TtbSetVel::clear_dec_x() {
  dec_x_ = 0;
}
inline float TtbSetVel::_internal_dec_x() const {
  return dec_x_;
}
inline float TtbSetVel::dec_x() const {
  // @@protoc_insertion_point(field_get:TtbSetVel.dec_x)
  return _internal_dec_x();
}
inline void TtbSetVel::_internal_set_dec_x(float value) {
  
  dec_x_ = value;
}
inline void TtbSetVel::set_dec_x(float value) {
  _internal_set_dec_x(value);
  // @@protoc_insertion_point(field_set:TtbSetVel.dec_x)
}

// float dec_y = 4;
inline void TtbSetVel::clear_dec_y() {
  dec_y_ = 0;
}
inline float TtbSetVel::_internal_dec_y() const {
  return dec_y_;
}
inline float TtbSetVel::dec_y() const {
  // @@protoc_insertion_point(field_get:TtbSetVel.dec_y)
  return _internal_dec_y();
}
inline void TtbSetVel::_internal_set_dec_y(float value) {
  
  dec_y_ = value;
}
inline void TtbSetVel::set_dec_y(float value) {
  _internal_set_dec_y(value);
  // @@protoc_insertion_point(field_set:TtbSetVel.dec_y)
}
...
// float pos_max_acc = 2;
inline void TtbSetPos::clear_pos_max_acc() {
  pos_max_acc_ = 0;
}
inline float TtbSetPos::_internal_pos_max_acc() const {
  return pos_max_acc_;
}
inline float TtbSetPos::pos_max_acc() const {
  // @@protoc_insertion_point(field_get:TtbSetPos.pos_max_acc)
  return _internal_pos_max_acc();
}
inline void TtbSetPos::_internal_set_pos_max_acc(float value) {
  
  pos_max_acc_ = value;
}
inline void TtbSetPos::set_pos_max_acc(float value) {
  _internal_set_pos_max_acc(value);
  // @@protoc_insertion_point(field_set:TtbSetPos.pos_max_acc)
}
