                                    ...
                                    Row{
                                        ...
                                        FluButton{
                                            ...
                                            onClicked: {
                                               ...
                                               // }
                                                //下发震动指令
                                                bridge.sendtoCpp({"method":"‌shakingtable.open","chl":"x","wave":waveCombox1.currentIndex,"peak":peakText1.text,"freq":freqText1.text,"mode":shakingModeCombox1.currentIndex,"position":posText1.text})
                                            }
                                        }
                                    ...
                                    Row{
                                        ...
                                        FluButton{
                                            ...
                                            onClicked: {
                                                ...
                                                //}
                                                //下发震动指令
                                                bridge.sendtoCpp({"method":"‌shakingtable.open","chl":"y","wave":waveCombox2.currentIndex,"peak":peakText2.text,"freq":freqText2.text,"mode":shakingModeCombox2.currentIndex,"position":posText2.text})
                                            }
                                        }
                        ...
                        ColumnLayout {            // ★ 用 ColumnLayout 取代 Column
                            ...
                            RowLayout {
                                ...
                                TextField {
                                    ...
                                    property color borderNormal: "#cccccc"
                                    property color borderFlash: "red"
                                    ...
                                    background: Rectangle {
                                        ...
                                        radius: 4
                                        border.width: 1
                                        border.color: xPosInput.activeFocus ? "#4a90e2" : xPosInput.borderNormal
                                    }
                                    ...
                                    SequentialAnimation {
                                        ...
                                        loops: 2 // 闪烁两次
                                        ColorAnimation {
                                            target: borderRectxpos.border
                                            property: "color"
                                            from: borderRectxpos.border.color
                                            to: "red"
                                            duration: 400
                                        ...
                                        ColorAnimation {
                                            ...
                                            property: "color"
                                            from: "red"
                                            to: xPosInput.activeFocus ? "#4a90e2" : xPosInput.borderNormal
                                            duration: 400
                                            easing.type: Easing.InOutQuad
                                        }
                                    }
                                ...
                                FluButton {
                                    Layout.preferredWidth: 120
                                    Layout.preferredHeight: 50
                                    font { family: "SimSun"; pixelSize: 20 }
                                    text: "移动"
                                    onClicked: {
                                        let missing = false

                                        xPosInput.focus = false
                                        xVelInput.focus = false
                                        xAccInput.focus = false

                                        if (xPosInput.text === "") {
                                            xPosInput.triggerFlash()
                                            missing = true
                                        }
                                        if (xVelInput.text === "") {
                                            xVelInput.triggerFlash()
                                            missing = true
                                        }
                                        if (xAccInput.text === "") {
                                            xAccInput.triggerFlash()
                                            missing = true
                                        }
                                        ...
                                        bridge.sendtoCpp({
                                            "method": "servo.setposx",
                                            "value": xPosInput.text,
                                            "vel": xVelInput.text,
                                            "acc": xAccInput.text
                                        })
                                    }
                                ...
                                TextField {
                                    ...
                                    background: Rectangle {
                                        ...
                                        radius: 4
                                        border.width: 1
                                        border.color: yPosInput.activeFocus ? "#4a90e2" : yPosInput.borderNormal
                                    }
                                    ...
                                    SequentialAnimation {
                                        ...
                                        loops: 2 // 闪两次
                                        ColorAnimation {
                                            target: borderRectypos.border
                                            property: "color"
                                            from: borderRectypos.border.color
                                            to: yPosInput.borderFlash
                                            duration: 400
                                            easing.type: Easing.InOutQuad
                                        }
                                        ColorAnimation {
                                            target: borderRectypos.border
                                            property: "color"
                                            from: yPosInput.borderFlash
                                            to: yPosInput.activeFocus ? "#4a90e2" : yPosInput.borderNormal
                                            duration: 400
                                            easing.type: Easing.InOutQuad
                                        }
                                    }
                                ...
                                FluButton {
                                    ...
                                    onClicked: {
                                        let missing = false
                                        yPosInput.focus = false
                                        yVelInput.focus = false
                                        yAccInput.focus = false

                                        if (yPosInput.text === "") {
                                            yPosInput.triggerFlash()
                                            missing = true
                                        }
                                        
                                        if (yVelInput.text === "") {
                                            yVelInput.triggerFlash()
                                            missing = true
                                        }
                                        if (yAccInput.text === "") {
                                            yAccInput.triggerFlash()
                                            missing = true
                                        }
                            ...
                            RowLayout {
                                ...
                                TextField {
                                    ...
                                    background: Rectangle {
                                        ...
                                        radius: 4
                                        border.width: 1
                                        border.color: xVelInput.activeFocus ? "#4a90e2" : xVelInput.borderNormal
                                    }
                                    ...
                                    SequentialAnimation {
                                        ...
                                        loops: 2 // 红-恢复 两次呼吸
                                        ColorAnimation {
                                            target: borderRectxvel.border
                                            property: "color"
                                            from: borderRectxvel.border.color
                                            to: xVelInput.borderFlash
                                            duration: 400
                                            easing.type: Easing.InOutQuad
                                        }
                                        ColorAnimation {
                                            target: borderRectxvel.border
                                            property: "color"
                                            from: xVelInput.borderFlash
                                            to: xVelInput.activeFocus ? "#4a90e2" : xVelInput.borderNormal
                                            duration: 400
                                            easing.type: Easing.InOutQuad
                                        }
                                    }
                                ...
                                TextField {
                                    ...
                                    background: Rectangle {
                                        ...
                                        radius: 4
                                        border.width: 1
                                        border.color: yVelInput.activeFocus ? "#4a90e2" : yVelInput.borderNormal
                                    }
                                    ...
                                    SequentialAnimation {
                                        ...
                                        loops: 2 // 红→原色 两次呼吸
                                        ColorAnimation {
                                            target: borderRectyvel.border
                                            property: "color"
                                            from: borderRectyvel.border.color
                                            to: yVelInput.borderFlash
                                            duration: 400
                                            easing.type: Easing.InOutQuad
                                        }
                                        ColorAnimation {
                                            target: borderRectyvel.border
                                            property: "color"
                                            from: yVelInput.borderFlash
                                            to: yVelInput.activeFocus ? "#4a90e2" : yVelInput.borderNormal
                                            duration: 400
                                            easing.type: Easing.InOutQuad
                                        }
                                    }
                            ...
                            RowLayout {
                                ...
                                TextField {
                                    ...
                                    Layout.fillWidth: true
                                    Layout.preferredWidth: 120
                                    placeholderText: "0.001～100.000"
                                    color: "#333333"
                                    font.pixelSize: 24
                                    validator: DoubleValidator { bottom: 0.001; top: 100.000; decimals: 3 }
                                    inputMethodHints: Qt.ImhFormattedNumbersOnly
                                    ...
                                    background: Rectangle {
                                        ...
                                        radius: 4
                                        border.width: 1
                                        border.color: xAccInput.activeFocus ? "#4a90e2" : xAccInput.borderNormal
                                    }
                                    ...
                                    SequentialAnimation {
                                        ...
                                        loops: 2
                                        ColorAnimation {
                                            target: borderRectxacc.border
                                            property: "color"
                                            from: borderRectxacc.border.color
                                            to: xAccInput.borderFlash
                                            duration: 400
                                            easing.type: Easing.InOutQuad
                                        }
                                        ColorAnimation {
                                            target: borderRectxacc.border
                                            property: "color"
                                            from: xAccInput.borderFlash
                                            to: xAccInput.activeFocus ? "#4a90e2" : xAccInput.borderNormal
                                            duration: 400
                                            easing.type: Easing.InOutQuad
                                        }
                                    }
                                ...
                                TextField {
                                    ...
                                    background: Rectangle {
                                        ...
                                        radius: 4
                                        border.width: 1
                                        border.color: yAccInput.activeFocus ? "#4a90e2" : yAccInput.borderNormal
                                    }
                                    ...
                                    SequentialAnimation {
                                        ...
                                        loops: 2
                                        ColorAnimation {
                                            target: borderRectyacc.border
                                            property: "color"
                                            from: borderRectyacc.border.color
                                            to: yAccInput.borderFlash
                                            duration: 400
                                            easing.type: Easing.InOutQuad
                                        }
                                        ColorAnimation {
                                            target: borderRectyacc.border
                                            property: "color"
                                            from: yAccInput.borderFlash
                                            to: yAccInput.activeFocus ? "#4a90e2" : yAccInput.borderNormal
                                            duration: 400
                                            easing.type: Easing.InOutQuad
                                        }
                                    }
                            ...
                            RowLayout {
                                ...
                                Button {
                                    ...
                                    onPressed: {
                                        ...
                                        bridge.sendtoCpp({
                                            "method": "servo.setvel",
                                            "value": {"x": 0, "y": parseFloat(yVelInput.text)},
                                            "acc": {"x": 0, "y": parseFloat(yAccInput.text)},
                                            "state": "pressed"
                                        })
                                    }
                            ...
                            RowLayout {
                                ...
                                Button {
                                    ...
                                    onPressed: {
                                        ...
                                        bridge.sendtoCpp({
                                            "method": "servo.setvel",
                                            "value": {"x": -parseFloat(xVelInput.text), "y": 0},
                                            "acc": {"x": parseFloat(xAccInput.text), "y": 0},
                                            "state": "pressed"
                                        })
                                    }
